      ...
      <div class="topic-continer">
        <div class='flex sm:flex-col md:flex-row lg:flex-row xl:flex-row 2xl:flex-row '>
          <div class="flex flex-col md:flex-row  w-full">
            <!-- First section -->
            <section class="flex items-center justify-between bg-white p-4 rounded-lg shadow-sm">
            ...
            <!-- Second section -->
            <section class="flex items-center space-x-2 rtl:space-x-reverse bg-white p-4">
              ...
              <div class="flex -space-x-2 rtl:space-x-reverse">
                ...
                <div class="w-8 h-8 rounded-full bg-gray-200 text-xs flex items-center justify-center border-2 border-white">
                  +90
                </div>
              </div>
